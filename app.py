...
def get_metrics(cust_df, prod_name):
    ...
    # Moving Average (3 months) - Sửa lỗi tháng 8
        ...
        if selected_cust != "-- Select --":
            ...
            with tab1:
                ...
                if not v_df.empty:
                    ...
                    if last_v > 15:
                        st.warning(f"Demand is **{last_v:.1f}% higher** than forecast. Check IC supply chain.")
                    elif last_v < -15:
            ...
            with tab2:
                ...
                # Xác định ngày cuối cùng có dữ liệu thực tế
